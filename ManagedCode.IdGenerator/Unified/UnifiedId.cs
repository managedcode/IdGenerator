    ...
    IComparable<long>, IEquatable<long>
{
    ...
    public static implicit operator ulong(UnifiedId id)
    {
        return id.hash;
    }
    ...
    public static implicit operator UnifiedId(ulong hash)
    {
        return new(hash);
    }
    ...
    /// </summary>
    /// <param name="id">UnifiedId.</param>
    public static implicit operator long(UnifiedId id)
    {
        return id.ToInt64();
    }
    ...
    public static implicit operator UnifiedId(long hash)
    {
        return new(hash);
    }
    ...
    /// </summary>
    /// <param name="id">UnifiedId.</param>
    public static implicit operator string(UnifiedId id)
    {
        return id.ToString();
    }
    ...
    public static implicit operator UnifiedId(string hex)
    {
        return Parse(hex);
    }
    ...
    /// </summary>
    /// <param name="hex">String HEX32.</param>
    /// s
