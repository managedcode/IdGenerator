...
{
    private readonly IdGenerator.Hashids.Hashids _hashids = new("this is my salt");

    [Fact]
    public void EncodingIsThreadSafe()
    {
        var hashids = new IdGenerator.Hashids.Hashids();
    ...
    public void SingleLong_Decodes()
    {
        ...
        _hashids.DecodeLong("jvNx4BjM5KYjv").Should().Equal(long.MaxValue);
    }
    ...
    {
        var hashids = new IdGenerator.Hashids.Hashids("this is my salt");
    ...
    {
        var hashLength = 18;
        var hashids = new IdGenerator.Hashids.Hashids("this is my salt", hashLength);
    ...
    {
        var hashids = new IdGenerator.Hashids.Hashids("this is my salt", 8);
    ...
    {
        Action invocation = () => new IdGenerator.Hashids.Hashids(alphabet: "aadsss");
    ...
    {
        var hashids = new IdGenerator.Hashids.Hashids(alphabet: "abcdefghijklmnopqrstuvwxyz1234567890_-");
    ...
    {
        var tooShortAlphabet = IdGenerator.Hashids.Hashids.DEFAULT_ALPHABET.Substring(0, IdGenerator.Hashids.Hashids.MIN_ALPHABET_LENGTH - 1);
        var invocation = () => new IdGenerator.Hashids.Hashids(alphabet: tooShortAlphabet);
        invocation.Should().Throw<ArgumentException>();
    }
    ...
    {
        var minLengthAlphabet = IdGenerator.Hashids.Hashids.DEFAULT_ALPHABET.Substring(0, IdGenerator.Hashids.Hashids.MIN_ALPHABET_LENGTH);
        var minLengthCtor = () => new IdGenerator.Hashids.Hashids(alphabet: minLengthAlphabet);
        minLengthCtor.Should().NotThrow();

        var largerLengthAlphabet = IdGenerator.Hashids.Hashids.DEFAULT_ALPHABET.Substring(0, IdGenerator.Hashids.Hashids.MIN_ALPHABET_LENGTH + 1);
        var largerLengthCtor = () => new IdGenerator.Hashids.Hashids(alphabet: largerLengthAlphabet);
    ...
    {
        Action invocation = () => new IdGenerator.Hashids.Hashids(alphabet: null);
    ...
    public void DefaultSaltIsBlank()
    {
        ...
        new IdGenerator.Hashids.Hashids().Encode(1, 2, 3).Should().Be("o2fXhV");
    }
    ...
    {
        _hashids.Decode("NkK9").Should().Equal(12345);
        new IdGenerator.Hashids.Hashids("different salt").Decode("NkK9").Should().Equal();
    }

    [Fact]
    public void CustomAlphabet_Roundtrip()
    {
        var hashids = new IdGenerator.Hashids.Hashids("this is my salt", 0, "ABCDEFGhijklmn34567890-:");
    ...
    {
        var hashids = new IdGenerator.Hashids.Hashids("this is my salt", 0, "ABCDEFGHIJKMNOPQRSTUVWXYZ23456789");
        var input = new[] { 1, 2, 3, 4, 5 };
    ...
    {
        var hashids = new IdGenerator.Hashids.Hashids("salt", minHashLength);
